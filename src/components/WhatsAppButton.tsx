...
const GOOGLE_ADS_CONVERSION_ID =
  "AW-18422698859/x6r2CJHdsO0cEOum0NBE";
...
const variants = {
  ...
  sun:
    "bg-sun text-accent-foreground px-8 py-4 text-sm hover:brightness-105 shadow-[0_14px_36px_-14px_oklch(0.79_0.13_76/0.75)]",
  glass:
